...
public class StatsPersistance {
	...
	@SuppressWarnings("unchecked")
	public static void addWSStatsToDB(Timestamp ts, long requestId,
		...
		map.put("REQUEST_ID", requestId);
		map.put("TIME_STAMP", ts);
		DerbyDbUtils.insert("HAWKEYE.WS_STATS", map);


	}

	@SuppressWarnings("unchecked")
	public static void addWatchList(String url) {

		@SuppressWarnings("rawtypes")
		Map map = new HashMap();		
		map.put("URL", url);
		DerbyDbUtils.insert("HAWKEYE.WATCHES", map);
