...
<td colspan=12>
		<div id="radiotab">
			...
			<input type="radio" id="radio6" name="radio" /><label for="radio6"><a href="MemoryUIServlet" target="iframe_a">MemoryUtilization</a></label>
			<input type="radio" id="radio7" name="radio" /><label for="radio7"><a href="Maintenance.jsp" target="iframe_a">Maintenance</a></label>									
			<input type="radio" id="radio8" name="radio" /><label for="radio8"><a href="WatchServlet?ch=display" target="iframe_a">Watches</a></label>
		</div>
</td>
</tr>
</table>
